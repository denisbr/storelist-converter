...
echo $(cat cpython-3.9.14+20221002-${ARCH}-${DIST}-install_only.tar.gz.sha256) cpython-3.9.14+20221002-${ARCH}-${DIST}-install_only.tar.gz | sha256sum --check || exit 1
sha256sum --check scie-jump-${OS}-${ARCH}${EXE}.sha256 || exit 1
